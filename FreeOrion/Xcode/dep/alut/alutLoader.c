...
void
GUTTEDalutLoadWAVFile (ALbyte *fileName, ALenum *format, void **data, ALsizei *size,
                 ALsizei *frequency
...
void
GUTTEDalutLoadWAVMemory (ALbyte *buffer, ALenum *format, void **data, ALsizei *size,
                   ALsizei *frequency
#if !defined(__APPLE__)
                   , ALboolean *loop
#endif
...
void
GUTTEDalutUnloadWAV (ALenum UNUSED (format), ALvoid *data, ALsizei UNUSED (size),
